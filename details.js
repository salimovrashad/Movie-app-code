const id1 = new URLSearchParams(location.search).get("id")
const movies = document.querySelector(".container")
const fetchApi = ()=>{
    fetch(`https://api.tvmaze.com/shows/${id1}`)
    .then(res=>res.json())
    .then((datas) => {
      let li = "";
      li += `<nav class="navbar navbar-expand-lg" style="height: 100px;">
  ...
  <div class="px-4 py-5 my-5 text-center">
      <img class="d-block mx-auto mb-4" src=${datas.image.medium}>
      <h1 class="display-5 fw-bold text-body-emphasis">${datas.name}</h1>
      <div class="col-lg-6 mx-auto">
        <p class="mb-4">${datas.summary}</p>
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
          <a href="./index.html" type="button" class="btn btn-outline-primary btn-lg px-4">Back</a>
        </div>
      </div>
    </div>
